<template>
	<view class="tmInput" :style="{
		...
		<view class="tmInputWrap" :style="[
            ...
            -->
			<slot name="leftIcon">
				<tm-icon :_style="`padding-left:${_inputPadding}`" v-if="_attrs.leftIcon || _attrs.prefix" :size="_attrs.fontSize"
					:name="_attrs.leftIcon || _attrs.prefix" :color="_attrs.iconColor || config.color"></tm-icon>
			</slot>
			...
			<slot name="rightIcon">
				<tm-icon :size="_attrs.fontSize" v-if="_attrs.rightIcon"
					:_style="_attrs.showClear ? 'margin-right:24rpx' : 'margin:0 24rpx'" :name="_attrs.rightIcon"
