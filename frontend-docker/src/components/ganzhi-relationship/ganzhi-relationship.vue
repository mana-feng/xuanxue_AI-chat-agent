      ...
      <view class="ganzhi-relationship-wrapper" :style="{ height: contentHeight + 'px' }">
        ...
        <view class="pillars-row">
          ...
          <view class="pillar-labels-row">
            <view v-for="(node, idx) in diagramData.nodes" :key="'label-'+idx" class="pillar-col">
          ...
          <view class="pillar-gz-row">
            <view v-for="(node, idx) in diagramData.nodes" :key="'gan-' + idx" class="pillar-gz-col">
          ...
          <view class="pillar-gz-row">
            <view v-for="(node, idx) in diagramData.nodes" :key="'zhi-' + idx" class="pillar-gz-col">
