...
function buildCspValue() {
	...
	const scriptSrc = ["'self'", 'blob:', 'https://www.statcounter.com'];
	const scriptSrcElem = ["'self'", 'blob:', 'https://www.statcounter.com'];
	const styleSrc = ["'self'"];
	...
	const connectSrc = ["'self'", 'https://c.statcounter.com', 'https://www.statcounter.com', 'ws:', 'wss:'];
	if (connectSrcExtra) {
