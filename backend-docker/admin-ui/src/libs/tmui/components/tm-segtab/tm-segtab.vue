<template>
    <view class="tm-segtab relative flex flex-col" ref="tm-segtab" :style="{ width: (scaledWidth + scaledGutter * 2) + 'rpx' }">
        <tm-sheet
        :border="props.border"
        :linear="props.linear"
        ...
        :no-level="true" :round="2" :height="scaledHeight" :color="props.bgColor" :width="scaledWidth"
            ...
            <!-- #endif -->
            <view class="absolute flex flex-row flex-row-center-start"
                :style="[
