<template>
	<header class="app-header">
		<view class="app-header__left">
			<view class="app-header__logo" @tap="goToDashboard">
				<image class="logo-icon" src="@/static/icons/F.png" mode="aspectFit"></image>
			</view>
		</view>
		<view class="app-header__nav">
			<view class="nav-btn" @tap="goToDashboard">仪表盘</view>
			<view class="nav-btn" @tap="goToUsers">用户</view>
			<view class="nav-btn" @tap="goToRecords">记录</view>
			<view class="nav-btn" @tap="goToAnnouncements">公告</view>
			<view class="nav-btn" @tap="goToLlmConfig">LLM</view>
			<view class="nav-btn" @tap="goToLlmQuota">配额</view>
			<view class="nav-btn" @tap="goToEmailConfig">邮箱</view>
		</view>
